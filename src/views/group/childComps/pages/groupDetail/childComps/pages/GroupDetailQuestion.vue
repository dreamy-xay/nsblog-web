 ...
 * @LastEditors: Z_Y_C
 * @LastEditTime: 2022-02-20 16:35:16
-->
<template>
  <div class="groud-detail-question">
    <div class="groud-detail-question-content">
      <base-select-head
        :selectTag="selectTag"
      ...
      <div
        class="groud-detail-question-content-list"
...
import { getGroupQuestions } from '@/network/api/groups';
...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    function getData() {
      ...
      getGroupQuestions(route.path.split('/')[2], selectTag.value, selectTime.value, limit, results.length)
        .then((data) => {
...
.groud-detail-question {
  @include flex(center, initial, column);

  .groud-detail-question-content {
    box-shadow: $shadow-0;
    background: $grey-0;
    ...
    .groud-detail-question-content-list {
      height: 107px;
      transition: 0.2s;
